...
def horizon_scan_profile(value: str | None) -> HorizonScanProfile:
    ...
    if horizon == TradeHorizon.LONG:
        return HorizonScanProfile(
            ...
            max_selected=_bounded_int("HORIZON_LONG_SELECTED_MAX", 12, minimum=1, maximum=15),
    ...
    if horizon == TradeHorizon.MID:
        return HorizonScanProfile(
            ...
            max_selected=_bounded_int("HORIZON_MID_SELECTED_MAX", 12, minimum=1, maximum=15),
    ...
    return HorizonScanProfile(
        ...
        max_selected=_bounded_int("HORIZON_SHORT_SELECTED_MAX", 10, minimum=1, maximum=15),
