...
class AggressiveShortStrategy:
    ...
    REGIME_PARAMS = {
        "BULL":  {"stop_loss_pct": -8.0, "take_profit_pct": 16.0},
        "THEME": {"stop_loss_pct": -9.0, "take_profit_pct": 18.0},
        "BEAR":  {"stop_loss_pct": -6.0, "take_profit_pct": 10.0},
    }
