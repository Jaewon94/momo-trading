...
const DIRECT_SETTING_BINDINGS = [
  ...
  bindValue('set-loss-streak-recovery-mode', 'LOSS_STREAK_RECOVERY_MODE'),
  bindValue('set-loss-streak-max-daily-buys', 'LOSS_STREAK_RECOVERY_MAX_DAILY_BUYS'),
  bindValue('set-loss-streak-max-order', 'LOSS_STREAK_RECOVERY_MAX_ORDER_KRW'),
  bindValue('set-loss-streak-max-position', 'LOSS_STREAK_RECOVERY_MAX_POSITION_PCT'),
  bindValue('set-loss-streak-size-multiplier', 'LOSS_STREAK_RECOVERY_SIZE_MULTIPLIER'),
  bindValue('set-loss-streak-min-change', 'LOSS_STREAK_RECOVERY_MIN_CHANGE_PCT'),
  bindValue('set-loss-streak-max-change', 'LOSS_STREAK_RECOVERY_MAX_CHANGE_PCT'),
