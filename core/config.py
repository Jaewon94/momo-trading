...
class Settings(BaseSettings):
    ...
    DAILY_OPS_REPORT_ENABLED: bool = True
    DAILY_OPS_REPORT_LLM_ENABLED: bool = True
    ...
    AGGRESSIVE_EXPOSURE_ALIGNMENT_ENABLED: bool = True
    AGGRESSIVE_TARGET_EXPOSURE_PCT: float = 25.0
    AGGRESSIVE_MIN_BUY_ORDER_KRW: int = 20_000_000
    AGGRESSIVE_EXPOSURE_MIN_CONFIDENCE: float = 0.65
    ...
    PARTIAL_TAKE_PROFIT_PCT_MID: float = 8.0
    PARTIAL_TAKE_PROFIT_PCT_LONG: float = 12.0
    ...
    PARTIAL_STOP_LOSS_ENABLED: bool = True
    PARTIAL_STOP_LOSS_SIZE_PCT_MID: float = 50.0
    PARTIAL_STOP_LOSS_SIZE_PCT_LONG: float = 33.0
    PARTIAL_STOP_LOSS_FULL_EXIT_EXTRA_PCT_MID: float = 2.5
    PARTIAL_STOP_LOSS_FULL_EXIT_EXTRA_PCT_LONG: float = 4.0
    ...
    TRAILING_PROFIT_ACTIVATE_PCT_MID: float = 8.0
    TRAILING_PROFIT_ACTIVATE_PCT_LONG: float = 12.0
    TRAILING_PROFIT_DRAWDOWN_PCT_SHORT: float = 1.0
    TRAILING_PROFIT_DRAWDOWN_PCT_MID: float = 4.0
    TRAILING_PROFIT_DRAWDOWN_PCT_LONG: float = 6.0
    DEFAULT_STOP_LOSS_PCT_SHORT: float = -3.0
    DEFAULT_STOP_LOSS_PCT_MID: float = -7.0
    DEFAULT_STOP_LOSS_PCT_LONG: float = -10.0
    DEFAULT_TAKE_PROFIT_PCT_SHORT: float = 5.0
    DEFAULT_TAKE_PROFIT_PCT_MID: float = 12.0
    DEFAULT_TAKE_PROFIT_PCT_LONG: float = 18.0
    ...
    HORIZON_SCAN_ENABLED: bool = True
    HORIZON_SCAN_MID_ENABLED: bool = True
    HORIZON_SCAN_MID_HOUR: int = 10
    HORIZON_SCAN_MID_MINUTE: int = 20
    HORIZON_SCAN_LONG_ENABLED: bool = True
    HORIZON_SCAN_LONG_DAY_OF_WEEK: str = "wed"
    HORIZON_SCAN_LONG_HOUR: int = 10
    HORIZON_SCAN_LONG_MINUTE: int = 40
    HORIZON_SHORT_MAX_CANDIDATES: int = 30
    HORIZON_MID_MAX_CANDIDATES: int = 60
    HORIZON_LONG_MAX_CANDIDATES: int = 100
    HORIZON_SHORT_SELECTED_MAX: int = 10
    HORIZON_MID_SELECTED_MAX: int = 12
    HORIZON_LONG_SELECTED_MAX: int = 12
    HORIZON_SHORT_NEWS_PRESSURE_CANDIDATES: int = 8
    HORIZON_MID_NEWS_PRESSURE_CANDIDATES: int = 20
    HORIZON_LONG_NEWS_PRESSURE_CANDIDATES: int = 30
    HORIZON_SHORT_NEWS_LOOKBACK_HOURS: int = 24
    HORIZON_MID_NEWS_LOOKBACK_HOURS: int = 168
    HORIZON_LONG_NEWS_LOOKBACK_HOURS: int = 720
    HORIZON_SHORT_NEWS_PROMPT_ITEMS: int = 3
    HORIZON_MID_NEWS_PROMPT_ITEMS: int = 5
    HORIZON_LONG_NEWS_PROMPT_ITEMS: int = 8
    HORIZON_SHORT_DAILY_CANDLE_COUNT: int = 60
    HORIZON_MID_DAILY_CANDLE_COUNT: int = 120
    HORIZON_LONG_DAILY_CANDLE_COUNT: int = 240
    HORIZON_SHORT_PREFERRED_CHANGE_MAX_PCT: float = 18.0
    HORIZON_MID_PREFERRED_CHANGE_MIN_PCT: float = -4.0
    HORIZON_MID_PREFERRED_CHANGE_MAX_PCT: float = 14.0
    HORIZON_LONG_PREFERRED_CHANGE_MIN_PCT: float = -10.0
    HORIZON_LONG_PREFERRED_CHANGE_MAX_PCT: float = 12.0
    MIN_HOLD_MINUTES_BEFORE_PROFIT_EXIT_SHORT: int = 15
    MIN_HOLD_MINUTES_BEFORE_PROFIT_EXIT_MID: int = 1440
    MIN_HOLD_MINUTES_BEFORE_PROFIT_EXIT_LONG: int = 2880
    MIN_HOLD_MINUTES_BEFORE_REVIEW_EXIT_SHORT: int = 15
    MIN_HOLD_MINUTES_BEFORE_REVIEW_EXIT_MID: int = 1440
    MIN_HOLD_MINUTES_BEFORE_REVIEW_EXIT_LONG: int = 2880
    MIN_HOLD_MINUTES_BEFORE_SOFT_STOP_EXIT_SHORT: int = 5
    MIN_HOLD_MINUTES_BEFORE_SOFT_STOP_EXIT_MID: int = 1440
    MIN_HOLD_MINUTES_BEFORE_SOFT_STOP_EXIT_LONG: int = 2880
