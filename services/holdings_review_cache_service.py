    ...
    def build_key(
        ...
        *,
        ...
        payload = {
            ...
            "news_context_hash": self._hash_text(holding_data.get("news_context_prompt") or ""),
            "news_context_tone": str(holding_data.get("news_context_tone") or "").upper(),
            "news_negative_pressure": self._optional_round(holding_data.get("news_context_negative_pressure"), 4),
            "news_item_count": int(holding_data.get("news_context_item_count", 0) or 0),
