...
def test_holdings_review_cache_key_changes_when_horizon_changes() -> None:
    service = HoldingsReviewCacheService()
    kwargs = {
        "holding_data": {
            "symbol": "005930",
        ...
        **kwargs,
        "holding_data": {
            **kwargs["holding_data"],
            "trade_horizon": "SHORT",
            "max_hold_days": 5,
            "min_hold_minutes_before_review_exit": 15,
            "min_hold_minutes_before_profit_exit": 15,
            "min_hold_minutes_before_soft_stop_exit": 5,
        },
    }
