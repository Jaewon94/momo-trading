...
- For news, disclosure, web context, or LLM research changes, keep [docs/architecture/news-intelligence-governance.md](docs/architecture/news-intelligence-governance.md) and `strategy/news_intelligence_policy.py` aligned.
